    ...
    <main className="mx-auto max-w-4xl px-6 py-16">
      ...
      <header className="mt-4 mb-10">
        ...
        <p className="prose-read mt-4 max-w-2xl text-neutral-400">
          Every wing of the museum on one timeline: what each author was writing,
          year by year, while the same world happened to all of them.
        </p>
                      ...
                      <p key={entry.franchiseId} className="text-sm leading-relaxed">
                        ...
                        {entry.works.map((w, i) => (
                          <span key={w.id} className="text-neutral-200">
                            ...
                            <Link
                              href={`/f/${entry.franchiseId}#w-${w.id.split("/").pop()}`}
